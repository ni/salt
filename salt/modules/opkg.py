...
def _process_with_progress(cmd, jid, total_packages_count):
    ...
    tag = "salt/minion/pkg_progress/{}".format(minion_id)
...
def install(
            ...
            if version_num is None:
                ...
                for version_condition in version_conditions:
                    ...
                    if operator_specified:
                        ...
                        pkgstr = f"{pkgname}{version_operator}{version_string}"
    ...
    if failed_to_update_feeds:
        feed_update_error = "Error getting repos: {}".format(", ".join(failed_to_update_feeds))
    errors = []
